const translations = {
  en: {
    ...
    "stats.topworst": "Unreliability Rank",
    ...
    "ranking.description":
      "Best and worst performing heating stations by incident frequency and duration.",
    "ranking.table.rank": "Rank",
    "ranking.table.name": "Station Name",
    "ranking.table.monthlyHours": "Monthly Average Incident Time",
  ...
  ro: {
    ...
    "stats.topworst": "Clasament Nefiabilitate",
    ...
    "ranking.description":
      "Cele mai bune și mai slabe stații de încălzire după frecvența și durata incidentelor.",
    "ranking.table.rank": "Clasament",
    "ranking.table.name": "Numele Stației",
    "ranking.table.monthlyHours": "Timp Mediu Incidente Lunare",
